...
json.forEach((item) => {
  ...
  img.onerror = () => {
    img.src = "Another/img/affiches_eidolon.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/affiches.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/carnets.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/cinema.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/coffret_d_artiste.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/coffret_typographique.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/corset.png"; // Replace with the path to your fallback image
  };
  
  // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/tachitisme.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/tim_burton.png"; // Replace with the path to your fallback image
    };
