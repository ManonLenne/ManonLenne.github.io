...
json.forEach((item) => {
  ...
  img.onerror = () => {
    img.src = "Another/img/img/affiches_eidolon.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/img/img/affiches.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/img/img/carnets.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/img/img/cinema.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/img/img/coffret_d_artiste.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/img/img/coffret_typographique.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/img/img/corset.png"; // Replace with the path to your fallback image
  };
  
  // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "Another/img/img/img/tachitisme.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "Another/img/img/img/tim_burton.png"; // Replace with the path to your fallback image
    };
    ...
    .catch((error) => {
      ...
      img.src = "Another/img/img/affiches_eidolon.png"; // Fallback image
    }
    );
