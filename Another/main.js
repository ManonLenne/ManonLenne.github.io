...
json.forEach((item) => {
  ...
  // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "./Another/img/affiches_eidolon.png"; // Adjusted path for GitHub
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "./Another/img/affiches.png"; // Adjusted path for GitHub
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "img/carnets.png"; // Replace with the path to your fallback image
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "img/cinema.png"; // Replace with the path to your fallback image
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "./Another/img/coffret_d_artiste.png"; // Adjusted path for GitHub
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "./Another/img/coffret_typographique.png"; // Adjusted path for GitHub
    };
    
      // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "./Another/img/corset.png"; // Adjusted path for GitHub
  };
  
  // Add a fallback image in case the main image fails to load
  img.onerror = () => {
    img.src = "./Another/img/tachitisme.png"; // Adjusted path for GitHub
  };
  
    // Add a fallback image in case the main image fails to load
    img.onerror = () => {
      img.src = "./Another/img/tim_burton.png"; // Adjusted path for GitHub
    };
    ...
    .catch((error) => {
      ...
      img.src = "Another/img/affiches_eidolon.png"; // Fallback image
    }
    );
